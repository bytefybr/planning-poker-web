...
export default function SupportButton() {
  ...
  useEffect(() => {
    // Mostrar tooltip e tocar som após 3 segundos
  ...
  const handleClick = () => {
    const message = encodeURIComponent("Olá, preciso de ajuda com o PlanPoker");
    window.open(`https://api.whatsapp.com/send/?phone=5511991987000&text=${message}`, "_blank");
  };
